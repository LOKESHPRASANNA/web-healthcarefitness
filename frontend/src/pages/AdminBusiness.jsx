    ...
    <div className="max-w-7xl mx-auto h-full pb-20 relative">
      ...
      >
        <div>
          ...
          <h1 className="text-4xl font-bold text-white tracking-tight mb-2">Business Dashboard</h1>
          <p className="text-slate-400">High-level financial and operational analytics across all branches.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="card p-6 bg-slate-900/60 border border-white/5">
          ...
          <h3 className="text-slate-400 text-sm font-bold uppercase tracking-wider mb-1">Total MRR</h3>
          <p className="text-3xl font-bold text-white">$75,000</p>
        </motion.div>
        
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="card p-6 bg-slate-900/60 border border-white/5">
          <div className="flex justify-between items-start mb-4">
          ...
          <h3 className="text-slate-400 text-sm font-bold uppercase tracking-wider mb-1">Active Members</h3>
          <p className="text-3xl font-bold text-white">2,520</p>
        </motion.div>

        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="card p-6 bg-slate-900/60 border border-white/5">
          <div className="flex justify-between items-start mb-4">
            <div className="p-3 bg-purple-500/20 rounded-xl text-purple-400"><Building2 size={24} /></div>
            <span className="text-xs font-bold text-slate-400 bg-slate-800 px-2 py-1 rounded-lg">Stable</span>
          </div>
          <h3 className="text-slate-400 text-sm font-bold uppercase tracking-wider mb-1">Total Branches</h3>
          <p className="text-3xl font-bold text-white">3</p>
        </motion.div>

        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} className="card p-6 bg-slate-900/60 border border-white/5">
          <div className="flex justify-between items-start mb-4">
          ...
          <h3 className="text-slate-400 text-sm font-bold uppercase tracking-wider mb-1">Avg LTV (Lifetime Value)</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        {/* Revenue Analytics */}
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.2 }} className="lg:col-span-2 card p-6 bg-slate-900/60 border border-white/5">
          <h3 className="text-lg font-bold text-white mb-6">Revenue Analytics (YTD)</h3>
        ...
        {/* Branch Performance */}
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.3 }} className="lg:col-span-1 card p-6 bg-slate-900/60 border border-white/5">
          ...
          <div className="bg-orange-500/10 border border-orange-500/20 p-4 rounded-xl flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-slate-300 text-xs">Member acquisition is down 15% WoW. Recommend deploying marketing budget.</p>
            </div>
          </div>
        </motion.div>
