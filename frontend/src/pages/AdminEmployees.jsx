...
export default function AdminEmployees() {
  ...
  return (
    <div className="max-w-7xl mx-auto h-full pb-20">
      ...
      >
        <div>
          <h1 className="text-4xl font-bold text-slate-800 tracking-tight mb-2">Employee Directory & Payroll</h1>
          <p className="text-slate-500">Manage staff roles, branch assignments, and process monthly payroll.</p>
        </div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-8">
        <div className="relative w-full md:w-96">
          ...
          <input 
            ...
            className="w-full bg-slate-900/60 border border-slate-200 rounded-xl pl-12 pr-4 py-3 text-slate-800 outline-none focus:border-accent transition-colors"
          />
        </div>
        <div className="flex gap-3 w-full md:w-auto">
          <button className="flex items-center justify-center gap-2 px-4 py-3 bg-slate-900/60 border border-slate-200 rounded-xl text-slate-600 hover:text-white transition-colors w-full md:w-auto">
                ...
                <tr key={emp.id} className="hover:bg-slate-800/30 transition-colors">
                  <td className="p-4">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-[#EEF4FF] flex items-center justify-center text-accent font-bold border border-slate-200">
                        {emp.name.charAt(0)}
                      </div>
                  ...
                  <td className="p-4">
                    <div className="flex flex-col">
                      <span className="text-slate-600 font-medium">{emp.role}</span>
                  ...
                  <td className="p-4 text-slate-500">{emp.branch}</td>
