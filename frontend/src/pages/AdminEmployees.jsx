...
export default function AdminEmployees() {
  ...
  return (
    <div className="max-w-7xl mx-auto h-full pb-20">
      ...
      >
        <div>
          <h1 className="font-display text-4xl md:text-5xl font-bold text-surface-900 tracking-tight mb-2">Employee Directory & Payroll</h1>
          <p className="text-surface-500">Manage staff roles, branch assignments, and process monthly payroll.</p>
        </div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-8">
        <div className="relative w-full md:w-96">
          ...
          <input 
            ...
            className="w-full bg-slate-900/60 border border-surface-200 rounded-xl pl-12 pr-4 py-3 text-surface-800 outline-none focus:border-accent transition-colors"
          />
        </div>
        <div className="flex gap-3 w-full md:w-auto">
          <button className="flex items-center justify-center gap-2 px-4 py-3 bg-slate-900/60 border border-surface-200 rounded-xl text-surface-600 hover:text-white transition-colors w-full md:w-auto">
      ...
      >
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            <thead>
              <tr className="border-b border-surface-200 text-surface-500 text-sm uppercase tracking-wider">
                ...
                <tr key={emp.id} className="hover:bg-slate-800/30 transition-colors">
                  <td className="p-4">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-[#EEF4FF] flex items-center justify-center text-accent font-bold border border-surface-200">
                        {emp.name.charAt(0)}
                      </div>
                      <span className="text-surface-800 font-bold">{emp.name}</span>
                    </div>
                  </td>
                  <td className="p-4">
                    <div className="flex flex-col">
                      <span className="text-surface-600 font-medium">{emp.role}</span>
                  ...
                  <td className="p-4 text-surface-500">{emp.branch}</td>
                  ...
                  <td className="p-4 text-center">
                    <button className="p-2 text-surface-500 hover:text-white hover:bg-surface-100/10 rounded-lg transition-colors">
